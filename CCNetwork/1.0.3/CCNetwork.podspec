...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lfsluoye/CCNetwork"
  ...
  s.author             = { "Caffrey" => "lfs736012@163.com" }
  ...
  s.source       = { :git => "https://github.com/lfsluoye/CCNetwork.git", :tag => s.version.to_s }
